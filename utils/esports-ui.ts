...
import type { EsportsMatch } from '@/types/esports';
import {
  formatDrawDate,
  teamDisplayName,
  type UiLeagueData,
...
export function groupEsportsMatchesByLeague(
  ...
  for (const m of matches) {
    ...
    const leagueName = m.league.name || 'E-Sports';
    const ui = mapEsportsMatchToUi(m, lang);
