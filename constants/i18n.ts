...
const translations = {
  en: {
    ...
    betListType: "Type",
    betListAll: "All",
    betListToWin: "ToWin(Esport&Fight)",
    ...
    newsFilterAll: "All",
    newsCategoryFootball: "Football",
    newsCategoryEsports: "E-Sports",
    newsCategoryFight: "Fight",
    ...
    footballLeagueFilter: "Filter by League",
    competitionFilter: "Filter by Event",
    footballFullTime: "Full Time",
    footballFirstHalf: "First Half",
  ...
  my: {
    ...
    activitiesDateFilterHint:
      "စတင်ရက်၊ ပြီးဆုံးရက် သို့မဟုတ် နှစ်ခုလုံး ရွေးနိုင်သည်",
    ...
    betListAll: "အားလုံး",
    betListToWin: "အနိုင်(E-Sports&လက်ဝှေ့)",
    ...
    newsFilterAll: "အားလုံး",
    newsCategoryFootball: "ဘောလုံး",
    newsCategoryEsports: "E-Sports",
    newsCategoryFight: "လက်ဝှေ့",
    ...
    footballLeagueFilter: "လိဂ်ရွေးရန်",
    competitionFilter: "ပြိုင်ပွဲရွေးရန်",
    footballFullTime: "ပွဲချိန်ပြည့်",
    footballFirstHalf: "ပထမပိုင်း",
