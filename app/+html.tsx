        ...
        <style
          dangerouslySetInnerHTML={{
            __html:
              ...
              '.burma-announce-track{flex:1;min-width:0;overflow:hidden;min-height:28px}' +
              ...
              '.burma-announce-text{flex-shrink:0;white-space:nowrap;padding-right:48px;font-size:14px;font-weight:500;line-height:1.85;color:#1A2E22}',
          }}
        />
      </head>
      <body>{children}</body>
